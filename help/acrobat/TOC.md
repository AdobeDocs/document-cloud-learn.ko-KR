...
+ Acrobat Studio의 Analyzer {#analyzer}
  ...
  + 사용 사례 {#use-cases}
    + [통합 후 계약 감사 M&amp;A](analyzer/use-case/m-and-a-post-audit.md)
    + [재정에서의 수익 및 감사 검토 가속화](analyzer/use-case/accelerate-revenue.md)
    + [데이터 프라이버시 위험을 완벽한 가시성 및 모니터링으로 전환](analyzer/use-case/data-privacy-risk.md)
...
+ 사용 사례 {#use-cases}
  ...
  + 업무 라인 {#lob}
    + 재무 {#finance}
      + [개요](use-cases/lob/finance/finance-overview.md)
      + [통찰력에서 전달까지 실행 준비가 완료된 재무 문서 준비](use-cases/lob/finance/finance-insights.md)
    + HR {#hr}
    ...
    + 마케팅 {#marketing}
      + [개요](use-cases/lob/marketing/marketing-overview.md)
      + [Acrobat Studio로 제품 출시 가속화](use-cases/lob/marketing/marketing-product-launch.md)
    + 영업 {#sales}
      + [개요](use-cases/lob/sales/sales-overview.md)
      + [Customer Intelligence를 성공적인 판매 자산으로 전환](use-cases/lob/sales/sales-insights.md)
  + 정부기관 {#gov}
