...
Acrobat Sign에서 [계약 수정](configure-modify-agreement.md)을 구성하고 관리하는 방법에 대해 알아봅니다.
...
<tr>
  <td>
    <a href="automatic-assignment-rules.md">
      <img alt="자동 사용자 할당 규칙 사용" src="../assets/automatic-assignment.png" />
    </a>
    <div>
...
<tr>
    ...
    <td>
      <a href="configure-modify-agreement.md">
        <img alt="계약 수정 구성 및 관리" src="../assets/configure-modify-govern.png" />
      </a>
      <div>
      <a href="configure-modify-agreement.md"><strong>계약 수정 구성 및 관리</strong></a>
      </div>
      <em>계약 수정 구성 및 관리 방법에 대해 알아보기</em>
