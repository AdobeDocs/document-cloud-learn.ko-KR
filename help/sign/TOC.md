...
+ 시작하기 {#getting-started}
   ...
   + 전송 {#getting-started-sending}
      ...
      + [문서를 한 서명자에게 보내기](sign-beginner-tutorials/send-to-single-recipient.md)
      ...
      + [재사용할 수 있는 템플릿을 생성합니다.](https://experienceleague.adobe.com/docs/document-cloud-learn/sign-learning-hub/admin-set-up/getting-started-admin/create-a-template.html)
      + [확인란 그룹을 사용하여 필수 선택 사항을 안내합니다.](sign-beginner-tutorials/checkbox-groups.md)
      + [사본 만들기 사용 시기](sign-beginner-tutorials/create-a-copy.md)
...
+ 고급 작업 {#advanced-tasks}
   ...
   + 전송 {#advanced-tasks-sending}
      ...
      + [사용자 정의 작업 과정 빌드](https://experienceleague.adobe.com/en/docs/document-cloud-learn/sign-learning-hub/advanced-tasks/advanced-tasks-managing/creating-a-report)
   ...
   + 관리 {#advanced-tasks-managing}
      + [보고 및 트랜잭션 사용량](sign-advanced-users/creating-a-report.md)
...
+ 관리 {#admin-set-up}
   ...
   + 시작하기 {#getting-started-admin}
      + [새 관리자용으로 시작하기](admin/get-started-admin.md)
      ...
      + [보고 및 트랜잭션 사용량](https://experienceleague.adobe.com/en/docs/document-cloud-learn/sign-learning-hub/advanced-tasks/advanced-tasks-managing/creating-a-report)
      ...
      + [계약 수정 구성 및 관리](admin/configure-modify-agreement.md)
...
+ 모바일 {#mobile}
   ...
   + 모바일 튜토리얼 {#mobile-tutorials}
      ...
      + [모바일 친화적 보기](mobile/mobile-friendly.md)
      + [모바일 친화적인 보기 만들기](mobile/create-mobile-friendly.md)
