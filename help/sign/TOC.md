...
+ 시작하기 {#getting-started}
   ...
   + 전송 {#getting-started-sending}
      ...
      + [재사용 가능한 템플릿 만들기](https://experienceleague.adobe.com/docs/document-cloud-learn/sign-learning-hub/admin-set-up/getting-started-admin/create-a-template.html)
...
+ 고급 작업 {#advanced-tasks}
   ...
   + 전송 {#advanced-tasks-sending}
      ...
      + [사용자 지정 워크플로 작성](https://experienceleague.adobe.com/en/docs/document-cloud-learn/sign-learning-hub/advanced-tasks/advanced-tasks-managing/creating-a-report)
